...
namespace Macadores.ZK
{
    public class ZKLib :IZKEM
    {
        ...
        { return objCZKEM.GetVendor(ref strVendor); }

        public bool GetWiegandFmt(int dwMachineNumber, ref string sWiegandFmt)
        { return objCZKEM.GetWiegandFmt(dwMachineNumber, ref sWiegandFmt); }
        ...
        { return objCZKEM.GetDeviceMAC(dwMachineNumber, ref sMAC); }
